...
export default function Card({level, levelTitle, textInfo}) {
  return (
    <Stack component='article' margin='1.7em 0'>
      ...
      left: {xs: '1em', md: '0'},  background: {xs: 'hsl(13, 100%, 96%)', md: 'none'}, borderRadius: {xs: '40px 0 0 40px', md: '0'}}} >
           <Box className='num-box' sx={{width: {xs: '60px', md: '75px'}, padding: '.4em', marginRight: '1em',borderRadius: '45px',  background: 'hsl(12, 88%, 59%)', color: 'white', textAlign: 'center'}} >
        ...
        <Typography margin='1em 0 .7em 0 ' color=' hsl(227, 12%, 61%)'  paddingLeft={3} component='p' >{textInfo}</Typography>
        </Stack>
    </Stack>
  )
}
