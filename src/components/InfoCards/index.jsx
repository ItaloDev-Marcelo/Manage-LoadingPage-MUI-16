...
export default function Card({level, levelTitle, textInfo}) {
  return (
    <Stack component='article' margin='1.7em 0'>
        <Box className='line' sx={{display: 'flex', alignItems: 'center', zIndex: '12', width: {xs: '100%', md: 'auto'}, position: 'relative', left: {xs: '1em', md: '0'},  background: {xs: 'hsl(13, 100%, 96%)', md: 'trasparent'}, borderRadius: {xs: '40px 0 0 40px', md: '0'}}} >
